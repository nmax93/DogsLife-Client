    ...
    render(){
        ...
        return (
            ...
            <FlatList style={styles.dogListContainer}
                ...
                ListFooterComponent={<AddDogPlusButton onPress={this.onPressAddDog} />}
                renderItem={({item}) => (
                    <TouchableOpacity onPress={() => { this.props.storeProfileScreen.setSelectedDog(item)
                    }}>
                        {selectedDog.id !== item.id ? 
                                    <Image style={styles.dogListImage} source={item.image} /> 
                                    :
                                    <Image style={styles.greenBorder} source={item.image} />}
                    </TouchableOpacity>
                )}
            />
            </View>
